    ...
    _createClass(Piece, [{
        ...
        value: function getPieces() {
            return [
                ...
                new Piece({
                    title: 'ACM-W Shirt',
                    description: 'Designed shirts to be sold to members of ACM-W.',
                    photoURL: 'acmw_shirt.png',
                    tags: [TAG.ILLUSTRATOR, TAG.TOP]
                }),
                new Piece({
                ...
                new Piece({
                    title: 'Fay',
                    description: 'Commissioned for the header of a website.',
                    photoURL: 'mfaywu.png',
                    tags: [TAG.ILLUSTRATOR, TAG.TOP]
                }),
                new Piece({
                ...
                new Piece({
                    title: 'Snapchat',
                    description: 'Snapchat filters designed for Phi Sigma Rho Orchid Ball and ACM Formal. Below: Illustrator design; Above: In use.',
                    photoURL: 'Snapchat_Filter_Mocks.png',
                    tags: [TAG.ILLUSTRATOR, TAG.TOP]
                }),
                new Piece({
