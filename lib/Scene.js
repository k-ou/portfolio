...
var Scene = function () {
    ...
    _createClass(Scene, [{
        ...
        value: function about() {
            ...
            p7.className = 'about';
            p7.innerHTML = 'Nowadays, I\'m making a name of myself in the graphic design program at Seattle Central Creative Academy.';

            var p8 = document.createElement('p');
            p8.className = 'about';
            p8.innerHTML = 'I\'m looking to expand my horizons and step out of my comfort zone.';

            var carbcat = document.createElement('img');
            carbcat.src = 'web_photos/hiker.jpg';
            carbcat.style.width = '500px';
            carbcat.style.boxShadow = '10px 10px 5px #888888';
            ...
            description.innerHTML = 'My first backpacking trip in Yosemite National Park, from Tuolumne Meadows to Yosemite Valley -- more than 28 miles!';
